...
var Modal = function () {
  function Modal() {
    ...
    this.$modalBtns = (0, _jquery2.default)('.open-modal');
    this.$modal = (0, _jquery2.default)('.modal');
    this.$closeBtn = (0, _jquery2.default)('.modal__close');
  ...
  _createClass(Modal, [{
    ...
    key: 'escKeyHandler',
    value: function escKeyHandler(e) {
      if (e.keyCode === 27) {
        this.closeModal();
      }
    }
...
var ScrollReveal = function () {
  function ScrollReveal(element, offset) {
  ...
  _createClass(StickyHeader, [{
      ...
      this.$pageSections.map(function () {
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction === 'down') {
              var currentLink = currentSection.getAttribute('data-header-link');
              that.$navLinks.removeClass('is-current-section');
              (0, _jquery2.default)(currentLink).addClass('is-current-section');
            }
          },
    ...
    value: function createHeaderWaypoint() {
      ...
      new Waypoint({
        ...
        handler: function handler(direction) {
          direction === 'down' ? (that.$nav.addClass('header--is-scrolling'), that.$navLogo.addClass('header__logo--is-scrolling')) : (that.$nav.removeClass('header--is-scrolling'), that.$navLogo.removeClass('header__logo--is-scrolling'));
        }
      });
    }
  }, {
...
var revealFeatureItems = new _scrollReveal2.default('feature-item', '85%');
var revealTestimonials = new _scrollReveal2.default('testimonial', '60%');

// Make nav sticky on desktop views
var stickyNav = new _stickyHeader2.default();
